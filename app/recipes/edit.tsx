...
export default function EditRecipeScreen() {
  ...
  const { getUserRecipe, updateUserRecipe } = useUserRecipes();
  const existingRecipe = getUserRecipe(id!);
  ...
  useEffect(() => {
    if (existingRecipe) {
      setTitle(existingRecipe.strMeal);
      setCategory(existingRecipe.strCategory || '');
      setInstructions(existingRecipe.strInstructions || '');
      setImageUri(existingRecipe.localImageUri || null);
    } else {
  ...
  const handleUpdate = async () => {
    ...
    const updatedRecipe = {
      ...
      strMealThumb: imageUri || existingRecipe!.strMealThumb,
    };

    try {
      await updateUserRecipe(updatedRecipe);
      ...
      >
        ...
        >
          <View style={styles.modalContent}>
            <Image
              source={{ uri: imageUri ?? existingRecipe.strMealThumb }}
